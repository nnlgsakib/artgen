...
def main():
    ...
    desc = input("Prompt: ")
    style = input("""
Style: default, paint, hdr, polygon, gouache, realistic, comic, line-art, malevolent, meme, throwback, ghibli, melancholic, provenance, darkfantasy, fantasy, mystical, hd, synthwave, vibrant, blacklight,vaporwave,
>>> """)
